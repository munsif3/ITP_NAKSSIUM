...
namespace SMSystemNew
{
    public partial class payment : MetroForm
    {
        ...
        {
            // TODO: This line of code loads data into the 'sudheesanDataSet.donation' table. You can move, or remove it, as needed.
            this.donationTableAdapter.Fill(this.sudheesanDataSet.donation);
            // TODO: This line of code loads data into the 'sudheesanDataSet.fees' table. You can move, or remove it, as needed.
            this.feesTableAdapter.Fill(this.sudheesanDataSet.fees);
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (radfees.Checked)
                {
                    ...
                    DataSet ds = dba.getPaymentDetail(regKey, aTable);
