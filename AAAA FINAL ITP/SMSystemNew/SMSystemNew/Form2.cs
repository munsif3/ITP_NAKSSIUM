...
namespace SMSystemNew
{
    ...
    public partial class studentDetails : MetroForm
    {
        ...
        {
            // TODO: This line of code loads data into the 'sudheesanDataSet.heath_details' table. You can move, or remove it, as needed.
            this.heath_detailsTableAdapter.Fill(this.sudheesanDataSet.heath_details);
            // TODO: This line of code loads data into the 'sudheesanDataSet.parent_details' table. You can move, or remove it, as needed.
            this.parent_detailsTableAdapter.Fill(this.sudheesanDataSet.parent_details);
            // TODO: This line of code loads data into the 'sudheesanDataSet.student' table. You can move, or remove it, as needed.
            this.studentTableAdapter.Fill(this.sudheesanDataSet.student);
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //changed 21/08/2016
                if ((sclassenrolled[1] != 'G') || (sclassenrolled.Length > 2))
                {
                    message += "\nclass enrolled";
                }

                if (spresentgrade.Length > 3)
                {
                    message += "\npresent grade";
                }
